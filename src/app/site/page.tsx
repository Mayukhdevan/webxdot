        ...
        <div className='bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative'>
          ...
          <div className='w-full h-40 relative z-30'>
            ...
            <div className='relative top-[-1rem]'>
              <div className='absolute inset-x-[5%] md:inset-x-0 top-0 bg-gradient-to-r from-transparent via-indigo-500 to-transparent h-[2px] blur-sm' />
          ...
          <div className='relative -top-36 z-10 flex flex-col justify-center items-center'>
            <Image
              src={preview}
              alt='banner images'
