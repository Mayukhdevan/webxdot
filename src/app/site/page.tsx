...
export default function Home() {
  return (
    <>
      <section className='w-full pt-36 flex relative flex-col items-center md:min-h-[100vh]'>
      ...
      <section className='gap-4 flex flex-col justify-center item-center mt-12 md:-mt-80'>
